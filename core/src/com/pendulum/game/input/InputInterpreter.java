    ...
    public String handleInput(ArrayList<InputEvent> events, String state, Camera camera, EntityHandler entities, World world, PlayScreen parent) {
        for (int i = 0; i < events.size(); i++) {
            Vector3 position = new Vector3(Gdx.input.getX(),
                    Gdx.input.getY(), 0);
            if (!(parent.tapOnScreenButton(position, events.get(i).getTYPE()))) {
                if (state == "TITLESCREEN") {
                    if (events.get(i).getTYPE() == "TAP" || events.get(i).getTYPE() == "TOUCH_UP") {
                        parent.screenTap(position, events.get(i).getTYPE());
                    }
                    if (events.get(i).getTYPE() == "TOUCH_DOWN" || events.get(i).getTYPE() == "PAN") {
                        parent.screenDown(position, events.get(i).getTYPE());
                    }
                }
                if (state == "PLAY") {
                    if (entities.getGameMode() != "SWINGS") {
                        if (events.get(i).getTYPE() == "TOUCH_DOWN") {
                        ...
                        if (events.get(i).getTYPE() == "TOUCH_UP") {
                            entities.destroyJoint(world);
                        }
                    } else {
                        if (events.get(i).getTYPE() == "TAP") {
