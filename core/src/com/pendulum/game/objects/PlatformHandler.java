...
public class PlatformHandler {
    ...
    public PlatformHandler(World world, float WORLD_WIDTH,
        ...
        pf_colors.add(new Color(252.0f/255.0f, 28.0f/255.0f, 96.0f/255.0f, 1.0f));
        pf_colors.add(new Color(224.0f/255.0f, 124.0f/255.0f, 12.0f/255.0f, 1.0f));
        pf_colors.add(new Color(6.0f/255.0f, 236.0f/255.0f, 142.0f/255.0f, 1.0f));
        pf_colors.add(new Color(62.0f/255.0f, 193.0f/255.0f, 31.0f/255.0f, 1.0f));
        pf_colors.add(new Color(188.0f/255.0f, 3.0f/255.0f, 204.0f/255.0f, 1.0f));
        pf_colors.add(new Color(105.0f/255.0f, 223.0f/255.0f, 68.0f/255.0f, 1.0f));
        pf_colors.add(new Color(1.0f/255.0f, 224.0f/255.0f, 205.0f/255.0f, 1.0f));
        pf_colors.add(new Color(40.0f/255.0f, 114.0f/255.0f, 248.0f/255.0f, 1.0f));
        pf_colors.add(new Color(143.0f/255.0f, 211.0f/255.0f, 5.0f/255.0f, 1.0f));
